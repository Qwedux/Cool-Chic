...
class FrameEncoderLogs(LossFunctionOutput):
    ...
    def __post_init__(self):
        ...
        #     if k in self.cool_chic_encoder_output.additional_data:
        #         setattr(self, k, self.cool_chic_encoder_output.additional_data.get(k))
        ...
        # if "detailed_rate_bit" in self.cool_chic_encoder_output.additional_data:
        #     detailed_rate_bit = self.cool_chic_encoder_output.additional_data.get(
        #         "detailed_rate_bit"
        #     )
...
def test(
    ...
    detailed_rate_nn, total_rate_nn_bit = model.get_network_rate()
    ...
    #     rate_latent_bpd=loss_fn_output.rate_latent_bpd,
    #     rate_img_bpd=loss_fn_output.rate_img_bpd,
    #     loss_function_output=loss_fn_output,
    #     cool_chic_encoder_output=frame_encoder_out,
    #     original_frame=frame,
    #     detailed_rate_nn=detailed_rate_nn,
    #     quantization_param_nn=model.get_network_quantization_step(),
    #     expgol_count_nn=model.get_network_expgol_count(),
