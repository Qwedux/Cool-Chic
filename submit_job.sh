...
python3 ./lossless_encode.py --image-index=$SLURM_ARRAY_TASK_ID --encoder-gain=64 --color-space=YCoCg --use-image-arm --experiment_name=16_12_2025_RGB_arm_chongus_no_color_regression_gain_test_Kodak
